<?PHP echo(IsSet($_POST['R2_Name']))?'<hr>
<h3>Registrant 2:&nbsp; '.$_POST['R2_Name'].'</h3>
<hr size="1">
':"";

if(isset($_POST['R2_Class1'])){
echo "<br/>
FRIDAY<br/>
<br/><b>Class 1 — 1:45&ndash;3:15 p.m.</b><br/>
";
if($_POST['R2_Class1']=="1JL"){
...
if(isset($_POST['R2_Class3'])){
echo "<br/>
SATURDAY MORNING<br/>
<br/><b>Class 3 — 9&ndash;9:40 a.m.</b><br/>
";
 if($_POST['R2_Class3']=="3AM"){
...
if(isset($_POST['R2_Class4'])){
echo "<b>Class 4 — 9:50&ndash;10:30 a.m.</b><br/>
";
 if($_POST['R2_Class4']=="4WG"){
...
if(isset($_POST['R2_Class5'])){
echo "<b>Class 5 — 10:40&ndash;11:20 a.m.</b><br/>
";
 if($_POST['R2_Class5']=="5DC"){
...
if(isset($_POST['R2_Class6'])){
echo "<b>Class 6 — 11:30 a.m. &ndash;12:10 p.m.</b><br/>
";
 if($_POST['R2_Class6']=="6SAK"){
...
if(isset($_POST['R2_Class9'])){
echo "<br/>
SUNDAY<br/>
<br/>
<b>Class 9 — 9&ndash;10:30 a.m.</b><br/>
";
 if($_POST['R2_Class9']=="9CA"){
...
if(isset($_POST['R2_Class10'])){
echo "<b>Class 10 — 10:45 a.m. &ndash;12:15 p.m.</b><br/>
";
 if($_POST['R2_Class10']=="10DL"){
