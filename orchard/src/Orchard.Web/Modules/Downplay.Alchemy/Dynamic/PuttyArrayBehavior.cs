...
namespace Downplay.Alchemy.Dynamic {
    public class StuffArrayBehavior : ClayBehavior {
        ...
        public override object InvokeMember(Func<object> proceed, object self, string name, INamedEnumerable<object> args) {
            switch (name) {
                case "AddRange":
                    _data.AddRange(((IEnumerable)args.Single()).OfType<object>().Select(o => new Stuff(o)));
                    return self;
                case "Add":
                    _data.AddRange(args.Select(o=>new Stuff(o)));
                    return self;
                case "Insert":
                    return IfInitialInteger(args, (index, arr) => { _data.InsertRange(index, arr.Select(o=>new Stuff(o))); return self; }, proceed);
                case "RemoveAt":
