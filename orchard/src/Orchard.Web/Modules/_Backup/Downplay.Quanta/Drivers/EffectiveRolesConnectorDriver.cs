...
{
    public class EffectiveRolesConnectorDriver : ModelDriver<ConnectorEventContext>
    {
        ...
        protected override ModelDriverResult Display(ConnectorEventContext model, dynamic shapeHelper, ModelDisplayShapeContext context)
        {
